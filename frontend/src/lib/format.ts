...
/** Truncate the first user message into a title. */
...
function activeLocale(locale?: string): string {
  return locale || i18n.resolvedLanguage || i18n.language || "vi";
}
